...
//  import Homepage from 'bundle-loader?lazy!babel-loader!./pages/home/HomePage';
 import RepositoryDetailPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/RepositoryDetailPage';
 import GridTest from 'bundle-loader?lazy!babel-loader!./pages/dashboard/GridTest';
 import GridTest1 from 'bundle-loader?lazy!babel-loader!./pages/dashboard/GridTest1';
 import WebDashboardViewPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/WebDashboardViewPage';
 import ActivityViewPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/ActivityViewPage';
 import DashboardViewPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/DashboardViewPage';
 import LandingPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/LandingPage';
 import AboutViewPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/AboutViewPage';
 import ContactViewPage from 'bundle-loader?lazy!babel-loader!./pages/dashboard/ContactViewPage';
...
// import ShowOnTheWar from 'pages/showontheway/ShowOnTheWay';
    ...
    return (
        <Route path="/" component={Container}>
            ...
            <Route
                ...
                onEnter={() => {}}
                getComponent={lazyLoadComponent(RepositoryDetailPage)}
            />
            <Route
                path="/gridtest"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(GridTest)}
            />
            <Route
                path="/gridtest1"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(GridTest1)}
            />
            <Route
                path="/activitiesview"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(ActivityViewPage)}
            />
            <Route
                path="/about"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(AboutViewPage)}
            />
            <Route
                path="/contact"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(ContactViewPage)}
            />
            <Route
                path="/dashboardview"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(DashboardViewPage)}
            />
            {/* <Route
                path="/showontheway"
                onEnter={() => {}}
                getComponent={lazyLoadComponent(ShowOnTheWay)}
            /> */}
            {/* <Route
                path="/restore"
                onEnter={() => {
